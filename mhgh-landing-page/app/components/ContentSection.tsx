  ...
  return (
    <section className="relative w-full h-auto z-30 md:-mt-[450px] 2xl:-mt-[560px] flex flex-col items-center justify-start pt-10 md:pt-20">
      ...
      <div className="w-full flex flex-col items-center z-10">
        {/* Desktop title */}
        <div className="hidden md:flex justify-center mb-6 mt-[480px] lg:mt-[500px]">
          <img
        ...
        {/* Mobile title */}
        <div className="flex md:hidden justify-center mb-4 -mt-[240px]">
          <img
      ...
      <div className="w-full max-w-4xl mx-auto z-10 px-2 md:px-0 -mt-30 sm:-mt-0">
        <div className="grid grid-cols-2 grid-rows-3 md:grid-cols-3 md:grid-rows-2 gap-2 md:gap-8 2xl:gap-10">
          {[
            ...
            <div key={i} className="flex flex-col items-center relative">
              <img
                ...
                width={192}
                height={146}
                className="absolute top-5 left-1/2 -translate-x-1/2 z-10 w-16 h-16 md:w-30 md:h-30 object-contain drop-shadow-xl"
                loading="lazy"
              />
              <img
                src="/gift-frame.png"
                ...
                width={160}
                height={160}
                className="w-25 h-25 md:w-40 md:h-40 object-contain mb-2 drop-shadow-lg relative z-0"
                loading="lazy"
              />
